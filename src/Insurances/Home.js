  ...
  const fetchData = async () => {
    try {
      const res = await fetch(
        "https://api.jsonbin.io/v3/b/663a3d38acd3cb34a8444e8c"
      );
  ...
  return (
    <div>
      ...
      <div className="mt-8 pb-10">
        <h1 className="font-bold text-white text-5xl absolute mt-[630px] ml-7">
          HOME INSURANCE
        </h1>
        <img
      ...
      {filteredPlans.map((plan) => (
        ...
        >
          <div
            ...
            className="cursor-pointer items-start justify-between bg-white-700 p-6 rounded-lg shadow-md pb-2 w-full lg:max-w-[1000px] flex flex-col lg:flex-row gap-4"
          >
