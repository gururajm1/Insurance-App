  ...
  const fetchData = async () => {
    try {
      const res = await fetch(
        "https://api.jsonbin.io/v3/b/6639ad23e41b4d34e4efece6"
      );
      ...
      {filteredPlans.map((plan) => (
        <div key={plan.id} className="my-4 flex justify-center">
          <div
            ...
            className="cursor-pointer items-start justify-between bg-white p-6 rounded-lg shadow-md pb-2 w-full lg:max-w-[1000px] flex flex-col lg:flex-row gap-4"
          >
